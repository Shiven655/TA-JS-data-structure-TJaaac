...
character.greet(){ prompt(I am("Name Here") and my title is ("Title Here"))}
...
character.function changeIsAdult(){
isAdult = !isAdult;
}
...
let character["keyName"] : "Maisie Williams";
